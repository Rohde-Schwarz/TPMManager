...
\ucinclude 
   \begin{compactitem}
      \item SRK authorization \ucref{srkauth}
      \item New Password \ucref{newpass}
   \end{compactitem}
\ucprecond TPM Owner set
...
\begin{figure}[h]
 ...
 \caption{''Ownership`` tab dialog \ucref{takeowner}, \ucref{changeowner}, \ucref{changesrk} and \ucref{clearowner}}
\end{figure}
\clearpage
...
\begin{figure}[h]
 ...
 \caption{TPM operational modes dialog implementing \ucref{deactivate} and \ucref{disable}}
\end{figure}
\clearpage
...
\begin{figure}[h]
 ...
 \caption{''Endorsement`` tab dialog \ucref{createek}, \ucref{readek}, \ucref{storeek} and \ucref{restrictek} }
\end{figure}
\clearpage
...
\begin{figure}[h]
 ...
 \caption{Tab dialog to warning about critical features \ucref{critical}}
\end{figure}
\clearpage
